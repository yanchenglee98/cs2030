...
//                        System.out.println(server + " is resting");
                        eventLog.add(new Event(new TypicalCustomer(-1), currentTime, States.SERVER_REST, server));
                        server.rest();
...
//                System.out.println(server + " rest til: " + p);
                server.back();
                eventLog.add(new Event(new TypicalCustomer(-1), currentTime + restPeriod, States.SERVER_BACK, server));
            }
